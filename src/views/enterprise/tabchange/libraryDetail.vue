    ...
    <div class="container-wrap">
        ...
        <footer class="post-detail-ft">
            <ul class="ft-ul">
                ...
                <li v-show='!status'><x-button class='button archivesbtn' @click.native="addarchives">加入档案库</x-button></li>
                <!-- <li v-show='status'><x-button class='button archivesbtn' @click.native="delarchives">移除档案库</x-button></li>-->
                <li v-show='status'><x-button class='button delbtn'>已在档案库</x-button></li>
            </ul>
        </footer>
        <div v-transfer-dom>
     ...
     export default {
        ...
        created(){
            ...
            resumedetail(this.$route.params.data.userId).then(res => {
                ...
                this.status = res.data.datas.employed
        ...
        methods: {
            ...
            appointment(){
                ...
                let data =  {
                    userId: this.this.$route.params.data.id
                };
...
<style lang="less" scoped>
    ...
    .post-detail-ft{
        ...
        .archivesbtn:last-child {
            background: rgb(110, 235, 221)!important;
        }
        .delbtn {
